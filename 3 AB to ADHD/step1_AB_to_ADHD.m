...
% load positive- and negative- AB networks
load('AB_AA.mat');
load('AB_BB.mat');
...
title({'High-AB network', ['r = ' num2str(R_pos) ', p = ' num2str(P_pos)]}, 'FontSize', 12);
...
ylabel('Network strength');
title({'Low-AB network', ['r = ' num2str(R_neg) ', p = ' num2str(P_neg)]}, 'FontSize', 12);
